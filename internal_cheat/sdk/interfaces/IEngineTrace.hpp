...
{
public:
    __forceinline Ray_t() : m_pWorldAxisTransform{}, m_IsRay{}, m_IsSwept{} {}

    __forceinline Ray_t(Vector const& start, Vector const& end) {
        m_Delta = end - start;
    ...
    __forceinline Ray_t(Vector const& start, Vector const& end, Vector const& mins, Vector const& maxs) {
        m_Delta = end - start;
        m_pWorldAxisTransform = nullptr;
