...
struct shot_record
{
	...
	lagcompensation::LagRecord_t* record = nullptr;
...
public:
	void register_shot(player_t* target, Vector eye_pos, lagcompensation::LagRecord_t* record, int fire_tick, HitscanPoint_t point, bool safe);
	void on_fsn();
