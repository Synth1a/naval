...
public:
	void setup();
	void get_skeleton();
	void studio_build_matrices(c_studio_hdr* hdr, const matrix3x4_t& worldTransform, Vector* pos, Quaternion* q, int boneMask, matrix3x4_t* out, uint32_t* boneComputed);
