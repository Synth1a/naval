...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Drag/Slider Flags"))
    {
        ...
        ImGui::SliderInt("SliderInt (0 -> 100)", &slider_i, 0, 100, "%d", false, flags);
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Tabs"))
    {
        ...
        if (ImGui::TreeNode("TabItemButton & Leading/Trailing flags"))
        {
            ...
            ImGui::CheckboxFlags("ImGuiTabBarFlags_TabListPopupButton", (unsigned int*)(unsigned int *)&tab_bar_flags, ImGuiTabBarFlags_TabListPopupButton);
            if (ImGui::CheckboxFlags("ImGuiTabBarFlags_FittingPolicyResizeDown", (unsigned int*)(unsigned int *)&tab_bar_flags, ImGuiTabBarFlags_FittingPolicyResizeDown))
                tab_bar_flags &= ~(ImGuiTabBarFlags_FittingPolicyMask_ ^ ImGuiTabBarFlags_FittingPolicyResizeDown);
            if (ImGui::CheckboxFlags("ImGuiTabBarFlags_FittingPolicyScroll", (unsigned int*)(unsigned int *)&tab_bar_flags, ImGuiTabBarFlags_FittingPolicyScroll))
                tab_bar_flags &= ~(ImGuiTabBarFlags_FittingPolicyMask_ ^ ImGuiTabBarFlags_FittingPolicyScroll);
...
{
    ImGui::CheckboxFlags("_DefaultHide", (unsigned int*)p_flags, ImGuiTableColumnFlags_DefaultHide);
    ImGui::CheckboxFlags("_DefaultSort", (unsigned int*)p_flags, ImGuiTableColumnFlags_DefaultSort);
    if (ImGui::CheckboxFlags("_WidthStretch", (unsigned int*)p_flags, ImGuiTableColumnFlags_WidthStretch))
        *p_flags &= ~(ImGuiTableColumnFlags_WidthMask_ ^ ImGuiTableColumnFlags_WidthStretch);
    if (ImGui::CheckboxFlags("_WidthFixed", (unsigned int*)p_flags, ImGuiTableColumnFlags_WidthFixed))
        *p_flags &= ~(ImGuiTableColumnFlags_WidthMask_ ^ ImGuiTableColumnFlags_WidthFixed);
    if (ImGui::CheckboxFlags("_WidthAuto", (unsigned int*)p_flags, ImGuiTableColumnFlags_WidthAuto))
        *p_flags &= ~(ImGuiTableColumnFlags_WidthMask_ ^ ImGuiTableColumnFlags_WidthAuto);
    ImGui::CheckboxFlags("_NoResize", (unsigned int*)p_flags, ImGuiTableColumnFlags_NoResize);
    ImGui::CheckboxFlags("_NoReorder", (unsigned int*)p_flags, ImGuiTableColumnFlags_NoReorder);
    ImGui::CheckboxFlags("_NoHide", (unsigned int*)p_flags, ImGuiTableColumnFlags_NoHide);
    ImGui::CheckboxFlags("_NoClip", (unsigned int*)p_flags, ImGuiTableColumnFlags_NoClip);
    ImGui::CheckboxFlags("_NoSort", (unsigned int*)p_flags, ImGuiTableColumnFlags_NoSort);
    ImGui::CheckboxFlags("_NoSortAscending", (unsigned int*)p_flags, ImGuiTableColumnFlags_NoSortAscending);
    ImGui::CheckboxFlags("_NoSortDescending", (unsigned int*)p_flags, ImGuiTableColumnFlags_NoSortDescending);
    ImGui::CheckboxFlags("_NoHeaderWidth", (unsigned int*)p_flags, ImGuiTableColumnFlags_NoHeaderWidth);
    ImGui::CheckboxFlags("_PreferSortAscending", (unsigned int*)p_flags, ImGuiTableColumnFlags_PreferSortAscending);
    ImGui::CheckboxFlags("_PreferSortDescending", (unsigned int*)p_flags, ImGuiTableColumnFlags_PreferSortDescending);
    ImGui::CheckboxFlags("_IndentEnable", (unsigned int*)p_flags, ImGuiTableColumnFlags_IndentEnable); ImGui::SameLine(); HelpMarker("Default for column 0");
    ImGui::CheckboxFlags("_IndentDisable", (unsigned int*)p_flags, ImGuiTableColumnFlags_IndentDisable); ImGui::SameLine(); HelpMarker("Default for column >0");
}

static void ShowTableColumnsStatusFlags(ImGuiTableColumnFlags flags)
{
    ImGui::CheckboxFlags("_IsEnabled", (unsigned int *)&flags, ImGuiTableColumnFlags_IsEnabled);
    ImGui::CheckboxFlags("_IsVisible", (unsigned int *)&flags, ImGuiTableColumnFlags_IsVisible);
    ImGui::CheckboxFlags("_IsSorted", (unsigned int *)&flags, ImGuiTableColumnFlags_IsSorted);
    ImGui::CheckboxFlags("_IsHovered", (unsigned int *)&flags, ImGuiTableColumnFlags_IsHovered);
}
...
static void ShowDemoWindowTables()
{
    ...
    if (ImGui::TreeNode("Padding"))
    {
        ...
        PushStyleCompact();
        ImGui::CheckboxFlags("ImGuiTableFlags_PadOuterX", (unsigned int *)&flags1, ImGuiTableFlags_PadOuterX);
        ImGui::SameLine(); HelpMarker("Enable outer-most padding (default if ImGuiTableFlags_BordersOuterV is set)");
        ImGui::CheckboxFlags("ImGuiTableFlags_NoPadOuterX", (unsigned int *)&flags1, ImGuiTableFlags_NoPadOuterX);
        ImGui::SameLine(); HelpMarker("Disable outer-most padding (default if ImGuiTableFlags_BordersOuterV is not set)");
        ImGui::CheckboxFlags("ImGuiTableFlags_NoPadInnerX", (unsigned int *)&flags1, ImGuiTableFlags_NoPadInnerX);
        ImGui::SameLine(); HelpMarker("Disable inner padding between columns (double inner padding if BordersOuterV is on, single inner padding if BordersOuterV is off)");
        ImGui::CheckboxFlags("ImGuiTableFlags_BordersOuterV", (unsigned int *)&flags1, ImGuiTableFlags_BordersOuterV);
        ImGui::CheckboxFlags("ImGuiTableFlags_BordersInnerV", (unsigned int *)&flags1, ImGuiTableFlags_BordersInnerV);
        ...
        PushStyleCompact();
        ImGui::CheckboxFlags("ImGuiTableFlags_Borders", (unsigned int *)&flags2, ImGuiTableFlags_Borders);
        ImGui::CheckboxFlags("ImGuiTableFlags_BordersH", (unsigned int *)&flags2, ImGuiTableFlags_BordersH);
        ImGui::CheckboxFlags("ImGuiTableFlags_BordersV", (unsigned int *)&flags2, ImGuiTableFlags_BordersV);
        ImGui::CheckboxFlags("ImGuiTableFlags_BordersInner", (unsigned int *)&flags2, ImGuiTableFlags_BordersInner);
        ImGui::CheckboxFlags("ImGuiTableFlags_BordersOuter", (unsigned int *)&flags2, ImGuiTableFlags_BordersOuter);
        ImGui::CheckboxFlags("ImGuiTableFlags_RowBg", (unsigned int *)&flags2, ImGuiTableFlags_RowBg);
        ImGui::CheckboxFlags("ImGuiTableFlags_Resizable", (unsigned int *)&flags2, ImGuiTableFlags_Resizable);
    ...
    if (ImGui::TreeNode("Sizing policies, cell contents"))
    {
        ...
        ImGui::CheckboxFlags("ImGuiTableFlags_ScrollX", (unsigned int *)&flags, ImGuiTableFlags_ScrollX);
        ImGui::CheckboxFlags("ImGuiTableFlags_ScrollY", (unsigned int *)&flags, ImGuiTableFlags_ScrollY);
        if (ImGui::CheckboxFlags("ImGuiTableFlags_SizingPolicyStretch", (unsigned int *)&flags, ImGuiTableFlags_SizingPolicyStretch))
        ...
        if (ImGui::CheckboxFlags("ImGuiTableFlags_SizingPolicyFixed", (unsigned int *)&flags, ImGuiTableFlags_SizingPolicyFixed))
        ...
        ImGui::CheckboxFlags("ImGuiTableFlags_PreciseWidths", (unsigned int *)&flags, ImGuiTableFlags_PreciseWidths);
        ...
        ImGui::PushID("flags3");
        ImGui::PushItemWidth(TEXT_BASE_WIDTH * 30);
        ImGui::CheckboxFlags("ImGuiTableFlags_ScrollX", (unsigned int *)&flags3, ImGuiTableFlags_ScrollX);
        if (ImGui::CheckboxFlags("ImGuiTableFlags_SizingPolicyStretch", (unsigned int *)&flags3, ImGuiTableFlags_SizingPolicyStretch))
            flags3 &= ~ImGuiTableFlags_SizingPolicyFixed;      // Can't specify both sizing polices so we clear the other
        if (ImGui::CheckboxFlags("ImGuiTableFlags_SizingPolicyFixed", (unsigned int *)&flags3, ImGuiTableFlags_SizingPolicyFixed))
    ...
    if (ImGui::TreeNode("Context menus"))
    {
        ...
        PushStyleCompact();
        ImGui::CheckboxFlags("ImGuiTableFlags_ContextMenuInBody", (unsigned int*)(unsigned int *)&flags1, ImGuiTableFlags_ContextMenuInBody);
        PopStyleCompact();
    ...
    if (ImGui::TreeNode("Sorting"))
    {
        ...
        ImGui::CheckboxFlags("ImGuiTableFlags_SortMulti", (unsigned int *)&flags, ImGuiTableFlags_SortMulti);
        ImGui::SameLine(); HelpMarker("When sorting is enabled: hold shift when clicking headers to sort on multiple column. TableGetSortSpecs() may return specs where (SpecsCount > 1).");
        ImGui::CheckboxFlags("ImGuiTableFlags_SortTristate", (unsigned int *)&flags, ImGuiTableFlags_SortTristate);
    ...
    if (ImGui::TreeNode("Advanced"))
    {
        ...
        if (ImGui::TreeNode("Options"))
        {
            ...
            if (ImGui::TreeNodeEx("Sizing:", ImGuiTreeNodeFlags_DefaultOpen))
            {
                ...
                ImGui::CheckboxFlags("ImGuiTableFlags_PreciseWidths", (unsigned int *)&flags, ImGuiTableFlags_PreciseWidths);
                ImGui::SameLine(); HelpMarker("Disable distributing remainder width to stretched columns (width allocation on a 100-wide table with 3 columns: Without this flag: 33,33,34. With this flag: 33,33,33). With larger number of columns, resizing will appear to be less smooth.");
                ImGui::CheckboxFlags("ImGuiTableFlags_SameWidths", (unsigned int *)&flags, ImGuiTableFlags_SameWidths);
                ImGui::CheckboxFlags("ImGuiTableFlags_NoClip", (unsigned int *)&flags, ImGuiTableFlags_NoClip);
