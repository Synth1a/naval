...
namespace math {
	...
	void vector_angles(const Vector& forward, Vector& angles, Vector* up = nullptr);
	...
	float distance_to_ray(const Vector& pos, const Vector& start, const Vector& end, float* along = nullptr, Vector* point_on_ray = nullptr);
